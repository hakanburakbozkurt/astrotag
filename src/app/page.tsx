...
export default function WelcomePage() {
  return (
    <main className="astrotag-welcome relative min-h-dvh overflow-hidden bg-[#070b14]">
      <Starfield />
      ...
      <div className="relative flex min-h-dvh flex-col items-center justify-center px-6 py-12">
        ...
        >
          ...
          >
            ...
            <div className="welcome-image-frame relative overflow-hidden rounded-[2rem] border border-white/10 bg-[#0c1222] p-3 shadow-[0_0_80px_rgba(251,191,36,0.15)] backdrop-blur-sm">
              <Image
          ...
          <h1 className="welcome-title mt-3 bg-gradient-to-b from-white via-amber-50 to-amber-300/90 bg-clip-text text-3xl font-extrabold tracking-tight text-transparent sm:text-4xl">
            AstroTag
          </h1>
          <p className="welcome-subtitle mt-4 max-w-xs text-sm leading-relaxed text-white/50">
          ...
          <a
            href={SITE_URL}
            className="welcome-footer mt-8 font-mono text-[9px] uppercase tracking-[0.2em] text-white/25 transition hover:text-white/40"
          >
            {SITE_HOST}
          </a>
        </motion.div>
