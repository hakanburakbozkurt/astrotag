...
export function NatalTabIcon({ className }: TabIconProps) {
  return (
    <IconShell className={className}>
...
export function NexusTabIcon({ className }: TabIconProps) {
  return (
    <IconShell className={className}>
      <circle cx="12" cy="12" r="2.2" />
      <path d="M12 2.8v2M12 19.2v2M4.2 7.2l1.4 1.4M18.4 16.4l1.4 1.4M2.8 12h2M19.2 12h2M4.2 16.8l1.4-1.4M18.4 7.6l1.4-1.4" />
      <path d="M8.2 8.2c1.8-1.8 5.8-1.8 7.6 0M8.2 15.8c1.8 1.8 5.8 1.8 7.6 0" />
    </IconShell>
  );
}
