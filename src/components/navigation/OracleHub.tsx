    ...
    <>
      ...
      >
        ...
        <section className="rounded-[28px] border border-amber-400/15 bg-amber-400/[0.04] p-5">
          ...
          <ul className="mt-3 space-y-2 text-sm leading-relaxed text-white/55">
            ...
            <li>Tarot, sezgisel kart yorumları sunar.</li>
            <li>Kozmik Profil, doğum haritası imzanızı derinlik seviyesine göre yorumlar.</li>
          </ul>
        </section>
      </TabPageScaffold>
      ...
      <AnimatePresence>
        ...
        {activeModule?.id === "natal-chart" && (
          <OracleModuleErrorBoundary module="natal-chart">
