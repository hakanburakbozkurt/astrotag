...
export default function PartnerProfileSection() {
  ...
  return (
    <motion.section
      ...
      className="scroll-mt-6 rounded-[28px] border border-white/10 bg-[#0f172a]/80 p-5 backdrop-blur-2xl sm:p-6"
    >
      <p className="text-[10px] uppercase tracking-[0.3em] text-amber-400/70">
        Kozmik Partner
      </p>
      <h2 className="mt-2 text-lg font-semibold text-white">Partner Profili</h2>
      <p className="mt-2 text-sm text-white/45">
        {hasExistingPartner
          ? "Partner bilgilerinizi güncelleyin."
