...
const tapButtonClass =
  "inline-flex min-h-11 min-w-[44px] items-center justify-center rounded-xl border border-zinc-700 bg-zinc-900 px-5 py-3 text-sm font-medium text-stone-300 transition active:scale-[0.98] hover:bg-zinc-900 sm:min-h-[44px]";
        ...
        <div className="mt-3 flex w-full flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="min-w-0 flex-1">
            <p className="text-base font-semibold leading-snug text-white sm:text-lg">
              Partner:{" "}
              <span className="text-stone-300">{partnerName}</span>
            </p>
