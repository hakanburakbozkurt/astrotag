    ...
    >
      ...
      <div className="mt-4 flex flex-col gap-2 sm:flex-row">
        <Link
          ...
          className="inline-flex min-h-11 flex-1 items-center justify-center rounded-xl border border-zinc-700 bg-zinc-900 px-5 py-3 text-sm font-medium text-stone-300 transition hover:bg-zinc-900"
        >
          Nexus · Günlük Akış
        </Link>
        <Link
          href="/dashboard/bonds"
          className="inline-flex min-h-11 flex-1 items-center justify-center rounded-xl border border-white/15 bg-white/[0.03] px-5 py-3 text-sm font-medium text-white/75 transition hover:border-zinc-700"
        >
          Uyumluluk
        </Link>
      </div>
