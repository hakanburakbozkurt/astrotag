          ...
          {FEATURE_CARDS.map((feature, index) => {
            ...
            return (
              <SalesMotion key={feature.id} transition={{ delay: index * 0.05 }}>
                <article className="flex h-full flex-col rounded-2xl border border-zinc-700 bg-gradient-to-br from-[#0f172a]/80 via-[#0a1020]/90 to-[#09090b]/95 p-5 shadow-lg backdrop-blur-xl">
                  <span className="inline-flex h-11 w-11 items-center justify-center rounded-xl border border-zinc-700 bg-zinc-900 text-stone-300">
