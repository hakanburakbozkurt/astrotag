...
export default function SalesLanding() {
  return (
    <main className="astrotag-sales astrotag-sales-journey relative min-h-dvh overflow-x-hidden bg-zinc-950 font-sans text-white">
      ...
      <div
        ...
        style={{
          background:
            'radial-gradient(ellipse 85% 55% at 50% 8%, rgba(255,255,255,0.08) 0%, transparent 58%), radial-gradient(ellipse 60% 40% at 80% 20%, rgba(99,102,241,0.08) 0%, transparent 55%)',
        }}
        aria-hidden
      />
