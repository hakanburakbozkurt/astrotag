...
export type ChartBodyId = PlanetId | MinorPointId;

export type AspectType = "conjunction" | "opposition" | "square" | "trine";

export type ExtendedAspectType = AspectType | "sextile" | "quincunx";

export type NatalChartViewMode = "classic" | "master";
