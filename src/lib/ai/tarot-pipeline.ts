...
function buildMediumUserPrompt(
  ...
  return `Aşağıdaki JSON, Emph ephemeris motorunun ürettiği GERÇEKLİK paketidir. Bunu tek kaynak kabul et; kart sembolizmi + natal harita etkisini birlikte oku.
